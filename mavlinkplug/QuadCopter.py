...
class QuadCopter(multiprocessing.Process):
    def __init__(self, zmq_context = None, zmq_in = None, zmq_out = None, lat = 0, long = 0, terrain_elev_ft = 0, h_agl_ft = 1, fdm_model = 'QuadCopter', jsbsim_root = None, dt = 1.0/100):
    ...
    def stop(self):
        self._fdm.stop_realtime() #Not sure it will work
    @staticmethod
    def mav_2_FL(string):
